...
class LockFreeJournal:
    ...
    def __init__(self):
        ...
        self.dir_did_exist_before_open = False
        self.did_exist_before_open = False
        self.lfj_dir = None
    ...
    class Tx:
        ...
        def op_code_to_name(op_code):
            if op_code == LockFreeJournal.Tx.OP_TX_HDR:
                return "OP_TX_HDR"
            elif op_code == LockFreeJournal.Tx.OP_ON_DISK_JOURNAL_HDR:
                return "OP_ON_DISK_JOURNAL_HDR"
            elif op_code == LockFreeJournal.Tx.OP_CREATE_STRM:
                return "OP_CREATE_STRM"
            elif op_code == LockFreeJournal.Tx.OP_CREATE_VEC:
                return "OP_CREATE_VEC"
            elif op_code == LockFreeJournal.Tx.OP_SET_VEC_ITEM:
                return "OP_SET_VEC_ITEM"
            elif op_code == LockFreeJournal.Tx.OP_PAD:
                return "OP_PAD"
            elif op_code == LockFreeJournal.Tx.OP_STORE_ORDER_DATA:
                return "OP_STORE_ORDER_DATA"
            elif op_code == LockFreeJournal.Tx.OP_SET_ITEM_POS_FLAG:
                return "OP_SET_ITEM_POS_FLAG"
            elif op_code == LockFreeJournal.Tx.OP_SET_VEC_STRM_NUM:
                return "OP_SET_VEC_STRM_NUM"
            elif op_code == LockFreeJournal.Tx.OP_SET_AUX_POS:
                return "OP_SET_AUX_POS"
            elif op_code == LockFreeJournal.Tx.OP_STORE_MULTI_ORDER_DATA:
    ...
    def get_strm(self, strm_num):
        # Implementation of get_strm function
        pass

    def get_vec(self, vec_num):
        # Implementation of get_vec function
        pass
